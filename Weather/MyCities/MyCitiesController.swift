...
class MyCitiesController: UITableViewController {
    ...
    @IBAction func addCity(segue: UIStoryboardSegue) {
        ...
        if segue.identifier == "addCity" {
            guard let allCitiesController = segue.source as? AllCitiesController else {
                return
            }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyAddedCities", for: indexPath) as! MyCitiesCell

        let city = addedCities[indexPath.row]
        
        cell.myCitiesName.text = city
